...
- **Pond** — water gradient, Figma fish, size = neglect (fresh 0.44× → 90 days 1.24×), three depth layers, rAF drift. Filtered-out fish stay dim. One 72px accent FAB in the pond. **Acted** sparks stay in the water as still decorations (lily, lotus, waterwheel, lantern, reeds) — click one to reopen the note.
